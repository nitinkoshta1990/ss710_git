...
<?php 
   ...
   <div class="col-md-9">
    ...
    <div class="tab-pane <?php echo $activeclass;?>" id="tab_2">
       <form role="form" id="add_multiple_education" action="<?php echo site_url('admin/resume/add_education') ?>" class="form-horizontal" method="post">
         <div class="row">
          <div class="col-md-12">
           <div class="tshadow mb25 bozero ">
    ...
    <div class="tab-pane <?php echo $activeclass;?>" id="tab_3">
       <form role="form" id="add_multiple_skill" action="<?php echo site_url('admin/resume/add_skill') ?>" class="form-horizontal" method="post">
         <div class="row">
          <div class="col-md-12">
           <div class="tshadow mb25 bozero ">
  ...
  <?php $activeclass="";  } ?>
   ...
   <?php if($this->customlib->get_additional_field_status('reference')) {  ?>
      ...
      <div class="tab-pane <?php echo $activeclass;;?>" id="tab_4">
       <form role="form" id="add_multiple_referensh" action="<?php echo site_url('admin/resume/add_referensh') ?>" class="form-horizontal" method="post">
         <div class="row">
          <div class="col-md-12">
           <div class="tshadow mb25 bozero ">
  ...
  <?php  $activeclass=""; } ?>
   ...
   <?php  if($this->customlib->get_additional_field_status('other_details')) {  ?>
      ...
      <div class="tab-pane <?php echo $activeclass;?>" id="tab_5">
       <form role="form" id="add_other_details" action="<?php echo site_url('admin/resume/add_other_details') ?>" class="form-horizontal" method="post">
         <div class="row">
          <div class="col-md-12">
           <div class="tshadow mb25 bozero ">
            <input type="hidden" id="student_id" name="student_id" value="<?php echo $id;?>">
