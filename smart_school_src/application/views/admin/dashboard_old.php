...
if ($this->rbac->hasPrivilege('staff_role_count_widget', 'can_view')) {
    ...
    <?php foreach ($roles as $key => $value) {
        ?>              <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-xs-12 admin-main">
                            <div class="admin-info">
                                <a href="#">
                                    <span class="text-c-purple"><i class="fa fa-user-o f-24"></i></span>
                                    <div class="admin-info-content">
                                        <span class="admin-box-number"><?php echo $value; ?></span>
                                        <span class="admin-box-text"><?php echo $key; ?></span>
    ...
    <div class="row">
        <div class="col-lg-9 col-md-12 col-sm-12">
           <div class="row row-flex2">
               <div class="col-lg-6 col-md-6 col-sm-12 flex-card">
                              <?php
$bar_chart = true;
...
if (($this->module_lib->hasActive('fees_collection')) || ($this->module_lib->hasActive('expense'))) {
    if ($this->rbac->hasPrivilege('fees_collection_and_expense_monthly_chart', 'can_view')) {
        ...
        ?>
                        ...
                        <div class="box borderwhite shadow">
                            <div class="box-header with-border">
                                <h3 class="box-title max-w-88per"><?php echo $this->lang->line('fees_collection_expenses_for'); ?> <?php echo $this->lang->line(strtolower(date('F'))) . " " . date('Y');
        ...
        ?></h3>
                            ...
                            <div class="box-body">
                                <div class="chart">
                                    <canvas id="barChart" class="chart-min-h-320"></canvas>
                                </div>
                            </div>
                        </div>
...
if (($this->module_lib->hasActive('fees_collection')) || ($this->module_lib->hasActive('expense'))) {
    if ($this->rbac->hasPrivilege('fees_collection_and_expense_yearly_chart', 'can_view')) {
        ...
        ?>
                        ...
                        <div class="box borderwhite shadow">
                            <div class="box-header with-border">
                                <h3 class="box-title max-w-88per"><?php echo $this->lang->line('fees_collection_expenses_for_session'); ?> <?php echo $this->setting_model->getCurrentSessionName(); ?></h3>
                            ...
                            <div class="box-body">
                                <div class="chart">
                                    <canvas id="lineChart" class="chart-min-h-320"></canvas>
                                </div>
                            </div>
                        </div>
...
?>
        ...
        <div class="col-lg-3 col-md-12 col-sm-12 flex-card">
            <div class="row">
<?php
...
if ($this->module_lib->hasActive('expense')) {
    ...
    <div class="row row-flex2">
        <div class="col-lg-9 col-md-12 col-sm-12 flex-card">
           <div class="row">
                        ...
                        <div class="box borderwhite shadow">
                            ...
                            <div class="box-body">
                                <div class="chart-responsive">
                                    <canvas id="doughnut-chart" class="chart-min-h-340" height="341"></canvas>
                                </div>
                            </div>
                        </div>
...
?>          </div><!--./col-lg-6-->
        ...
        ?>
                        ...
                        <div class="box borderwhite shadow">
                            ...
                            <div class="box-body">
                                <div class="chart-responsive">
                                    <canvas id="doughnut-chart1" class="chart-min-h-340" height="341"></canvas>
                                </div>
                            </div>
                        </div>
...
<?php 
    if ($this->rbac->hasPrivilege('staff_approved_leave_widegts', 'can_view')) {
        ?>
                    <div class="col-lg-12 col-md-4 col-sm-12">
                        <div class="topprograssstart shadow">
                            <p class="text-uppercase mt5 clearfix"><i class="fa fa-ioxhost ftlayer"></i> <?php echo $this->lang->line('staff_approved_leave'); ?><span class="pull-right"><?php echo ($getStaffApproveMonthlyLeave) + 0; ?>/<?php echo ($getStaffMonthlyLeave); ?></span>
                            </p>
                            <div class="progress-group">
                                <div class="progress progress-minibar">
...
<?php 
    if ($this->rbac->hasPrivilege('student_approved_leave_widegts', 'can_view')) {
        ?>
                    <div class="col-lg-12 col-md-4 col-sm-12">
                        <div class="topprograssstart shadow">
                            <p class="text-uppercase mt5 clearfix"><i class="fa fa-ioxhost ftlayer"></i> <?php echo $this->lang->line('student_approved_leave'); ?><span class="pull-right"><?php echo ($getStudentApproveMonthlyLeave) + 0; ?>/<?php echo ($getStudentMonthlyLeave); ?></span>
                            </p>
                            <div class="progress-group">
                                <div class="progress progress-minibar">
...
if ($this->module_lib->hasActive('calendar_to_do_list')) {
    if ($this->rbac->hasPrivilege('calendar_to_do_list', 'can_view')) {
        $div_rol = 3;
        ?>
                        <div class="box shadow borderwhite">
                            <div class="box-body">
                                <!-- THE CALENDAR -->
                                <div id="calendar"></div>
                            </div>
