                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <script
                                                ...
                                                data-amount="<?php echo ((number_format((float)(convertBaseAmountCurrencyFormat($amount)), 2, '.', '')) * 100); ?>"
                                                data-name="<?php echo $name; ?>"
                                                data-description="<?php echo 'Online fees deposit'; ?>"
                                                data-image="<?php echo base_url('uploads/school_content/logo/' . $setting->image); ?>"
                                                data-locale="auto"
                                                data-zip-code="true"
