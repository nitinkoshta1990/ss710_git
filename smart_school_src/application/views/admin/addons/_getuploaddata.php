                        ...
                        <div class="rate">
                                        <div class="d-flex align-items-center mb-xl-3 mb-2">
                                            <div class="ms-auto mr-sm-auto">
                                                ...
                                                ?>
                                                    <button type="button" data-product-id="<?php echo $content_value->product_id; ?>" data-directory="<?php echo $content_value->directory; ?>" class="btn btn-success  btn-xs install" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('please_wait'); ?>"><?php echo $this->lang->line('install');?></button>
